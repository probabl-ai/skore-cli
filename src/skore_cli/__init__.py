...
_COMMANDS = [
    ("login", "Authenticate this project with Skore Hub."),
    ("agent", "Configure and launch a Skore Hub agent harness."),
...
def _render_help(detected: Agent | None) -> str:
    ...
    lines.append(
        "  skore login                   Authenticate this project with Skore Hub"
    )
